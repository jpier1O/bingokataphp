...
trait Mixin
{
     ...
     * @return void
     */
    public static function nullOrNumberPositiveeger($value, $message = '')
    {
        static::__callStatic('nullOrNumberPositiveeger', array($value, $message));
    }
     ...
     * @return void
     */
    public static function allNumberPositiveeger($value, $message = '')
    {
        static::__callStatic('allNumberPositiveeger', array($value, $message));
    }
